      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 mb-12">
          ...
          <div className="md:col-span-1 lg:col-span-1">
            <h3 className="text-lg font-bold mb-4">SECAN</h3>
            <p className="text-sm text-white/80 mb-4">
              The leading professional body for anatomists in Nigeria, committed to excellence in anatomical science.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm mb-6">
              <div className="flex items-start gap-2">
                ...
                <p className="text-white/80">
                  Department of Anatomy, University of Nigeria, Nsukka, Enugu State, Nigeria
                </p>
              </div>
           ...
           <div className="">
            ...
            {subscribed && (
              <p className="text-sm text-green-300 mt-2">Thank you for subscribing!</p>
            )}
           </div>
        </div>
        ...
        <div className="border-t border-white/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-white/80">
            <p>&copy; {currentYear} Society of Experimental and Clinical Anatomists of Nigeria (SECAN). All rights reserved.</p>
